hh# 📥 دانلود ویدیو از یوتیوب با GitHub Actions
s
این مخزن با استفاده از **GitHub Actions** بaده که sطa **ارسال لینک یوتیوب توی پیام کامیت**، ویدیو به‌صورت خودکار دانلود بشه و توی مخزن ذخیره بشه.k
adsw
ایده اصلی این بود که بدون نیاز به فیلترشکن و کانفیگ‌های گرون، بتaهای مورد علاقه‌مون رو ذخیره کنیم. فقط کافیه لینک ویدیو رو کپی کنی و با این اکشن دانلودش کنی.
]
> [!TIP]s
> برای دیدن لیست ویدیوها احتمالاً نیاز به فیلترشکن داری، ولی پیشنهاد من اینه که از پروژه [MITM-DomainFronting]w(https://github.com/patterniha/MITM-DomainFronting) استفاده کنی تا بدون فیلترشکن هم بتونی به یوتیوب دسترسی داشته باشی.
saaaa
<br><br>slosa
ds
## 🚀 تنظیمات اولیهsر s)
